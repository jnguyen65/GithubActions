[![Run App JustinNguyen](https://github.com/jnguyen65/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jnguyen65/GithubActions/actions/workflows/run-app.yaml)
